...
CC1101 pin connections : 18=SCK, 19=MISO, 23=MOSI, 5=CS, 4=GDO0, 3.3V=VCC, GND=GND
...
The data is displayed on the Serial Monitor output of the Arduino IDE (speed 115200 baud)
